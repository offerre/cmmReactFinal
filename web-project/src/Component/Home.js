  ...
  render(){
    return(
        ...
        <div className="row">
                ...
                <div className="w3-display-container">
                  ...
                  <span className="w3-tag w3-display-topleft">Sale</span>
                    <div className="w3-display-middle w3-display-hover">
                      <a href="/Products"><button className="w3-button w3-black">Buy now <i className="fa fa-shopping-cart"></i></button></a>
                    </div>
                  </div>
         ...
         <div className="w3-row">
            <div className="w3-col w3-padding-64 w3-center"><p><a href="/Products" className="w3-bar-item"><img src="Promo2.png" className="w3-round-xxlarge w3-image w3-opacity w3-hover-opacity-off" width="600" alt="1" /></a></p></div>
        </div>
