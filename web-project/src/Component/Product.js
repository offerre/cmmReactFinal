            ...
            <div className="w3-padding-64 Products-Title">Products</div>
              ...
              <div className="w3-col l3 s6">
                ...
                <div className="w3-container">
                  ...
                  <span className="w3-tag w3-display-topleft">New</span>
                    ...
                    <a href="/Order"><button className="w3-button w3-black w3-myFont w3-animate-opacity">Buy now <i className="fa fa-shopping-cart"></i></button></a>
                    </div>
                  </div>
              ...
              <div className="w3-col l3 s6">
                ...
                <div className="w3-display-container">
                  ...
                  <span className="w3-tag w3-display-topleft">Sale</span>
                    <div className="w3-display-middle w3-display-hover">
                    <a href="/Order"><button className="w3-button w3-black w3-myFont w3-animate-opacity">Buy now <i className="fa fa-shopping-cart"></i></button></a>                    </div>
                  </div>
